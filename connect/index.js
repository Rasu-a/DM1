...
if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	...
	let butown = [{urlButton: {displayText: 'Creator 👦️',url: 'https://wa.me/6285609233482?text=Assalamualaikum'}}, {urlButton: {displayText: 'Subscribe 📱️',url: 'https://www.youtube.com/c/FBOTZYT'}}, {urlButton: {displayText: 'Grup Creator 📺️',url: 'https://chat.whatsapp.com/CSqakw6x2wRIOWTPL5a6a9'}}]
    ...
    let imgdev = await getBuffer('https://telegra.ph/file/6596eaaa475b9e2cef1a0.jpg')
    let butdev = [{urlButton: {displayText: 'Owner 👦',url: `https://wa.me/${global.Rowner}`}}]
    let txtdev = `Halo Creator 👋, Izin pakai Sc nya`
    lolcatjs.fromString('Sukses Mengirim Pesan Ke Creator ☑️')
    ichi.sendButtonLoc("6285609233482@s.whatsapp.net", txtdev, global.ownerName, imgdev, butdev)
	}
} catch (err) {
